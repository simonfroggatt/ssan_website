...
if (!defined('LiveHelpJavaScriptInserted')) {
	...
	// JavaScript Settings
	$settingsjs = 'var Chatstack = {};' . "\n";
	$settingsjs .= 'Chatstack.server = \'' . $url . '\';' . "\n";

	// Embedded Chat
	if ($embedded) {
		$settingsjs .= 'Chatstack.embedded = true;' . "\n";
	}
  ...
  $javascript .= '			Chatstack.e = []; Chatstack.ready = function (c) { Chatstack.e.push(c); }' . "\n";
	...
	$javascript .= '			b.src = (\'https:\' == document.location.protocol ? \'https://\' : \'http://\') + Chatstack.server + \'/livehelp/scripts/jquery.livehelp.min.js\';' . "\n";
