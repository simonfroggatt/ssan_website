...
<a href="#" class="LiveHelpButton"><img src="<?php echo($params->get('url', '/livehelp/')); ?>status.php" id="LiveHelpStatus" name="LiveHelpStatus" class="LiveHelpStatus" border="0" alt="Live Help" title="Live Help"/></a>
