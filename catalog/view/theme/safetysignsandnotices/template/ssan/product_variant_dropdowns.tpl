...
<div class="form-group row">
  <div class="col-xs-6"><span class="h2">£</span><span id="priceDropDown" class="h2"></span><br><span class="pricetax" id="priceDropDownTax">(inc VAT £3.45)</span></div>
  <div class="col-xs-6">
...
<script>
  ...
  $('#button-cart-dropdown').on('click', function() {
    ...
    var EEproductPrice = $('#priceDropDown').html();//getBulkPricingValue(EEvariableInfo.discount_array, EEproductQuantity);
    ...
    'ecommerce': {
      ...
      'add': {                                // 'add' actionFieldObject measures.
        'products': [{                        //  adding a product to a shopping cart.
          'name': EEproductName,
          'id': EEid.toString(),
          'price': EEproductPrice.toString(),
        //  'variant': 'EEproductVariant',
          'quantity': EEproductQuantity
         }]
      }
    }
      });
