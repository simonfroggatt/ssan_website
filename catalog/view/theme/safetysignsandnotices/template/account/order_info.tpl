...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <h2><?php echo $heading_title; ?></h2><div class="pull-right"><a href="<?php echo $invoice; ?>" class="btn btn-primary" target="_blank"><?php echo $button_print; ?></a></div>
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <?php if($product['svg_raw'] != null) { ?>
              <div id="svgThumb">

                  <?php echo html_entity_decode($product['svg_raw']) ; ?>
              </svg>
              </div>
            <?php } else {?>
            ...
            <?php }?>
              ...
              <br /> <span class="product-variants"><?php echo $product['size_name']; ?> - <?php echo $product['material_name']; ?></span>
      ...
      <div class="buttons clearfix">
        <div class="pull-right"><a href="<?php echo $invoice; ?>" class="btn btn-primary" target="_blank"><?php echo $button_print; ?></a></div>
