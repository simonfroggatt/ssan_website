...
})(window,document,'script','dataLayer','GTM-M994FTF');</script>
...
<body class="<?php echo $class; ?>">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M994FTF"
      ...
      <div class="container">
        <nav id="menu" class="navbar">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <ul class="nav navbar-right navbar-cart hidden-xs">
              <li>
