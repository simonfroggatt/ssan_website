  ...
  <div class="col-sm-6">
    ...
    <!--  <div class="form-group ">
        <input type="text" id="input-payment-firstname" name="firstname" class="form-control" required>
        <label class="form-control-placeholder" for="input-payment-firstname"><?php echo $entry_firstname; ?></label>
      </div> -->
      <div class="form-group required">
