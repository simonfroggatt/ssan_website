...
*/
    $.ajax({
      ...
      success: function(data) {
        ...
        var myJSON = JSON.stringify(svgData);


        if(blisIE) {

          var Nodes=Array.prototype.slice.call(svgData.childNodes);
          var tmp = svgData.childNodes;
          var tmp2 = tmp[1]
          var adopted = document.importNode(tmp2, true);
          var tmp3;
        // var xmlser = new XMLSerializer();
          //tmp.forEach(function(svgpart){
        //      svgCode += svgpart.xml;
        //  });
          //  oXML.xml
          var tmp4 = tmp2.xml;
