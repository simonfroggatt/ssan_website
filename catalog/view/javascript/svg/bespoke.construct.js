...
/* public  */
    ...
    this.setSymbol = function(symbolNumber, symbolPath, symbolInfo)
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                vars.symbols[symbolNumber].symbolWidth = parseFloat(data.width);
                vars.symbols[symbolNumber].symbolHeight = parseFloat(data.height);
                vars.symbols[symbolNumber].svgCode = data.svgCode;
                vars.symbols[symbolNumber].viewBox = data.viewBox;
 ...
 this.setSymbolOld = function(symbolNumber, symbolPath, symbolInfo)
 {
/*    $.ajax({
      async: false,
      type: 'GET',
