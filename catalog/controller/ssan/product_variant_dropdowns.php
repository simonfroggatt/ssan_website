...
class ControllerSsanProductVariantDropdowns extends Controller {
    public function index() {

        $this->load->language('ssan/product_variant_dropdowns');
...
*/
        ...
        $data['variant_product_name'] =  $variant['product_name'];
        $data['preselect_variant'] = $variant['cheapest_variant'];

        if(isset($this->request->get['variantid'])){
            $data['preselect_variant'] = $this->request->get['variantid'];
        ...
        return $this->load->view('ssan/product_variant_dropdowns', $data);
