<?php
class ControllerExtensionFeedGoogleMerchantCheck extends Controller {
	...
	if (isset($this->request->get['catid'])) {
			$output .= $this->getCategories($this->request->get['catid']);
	}
	else{
	...
	protected function getCategories($parent_id, $current_path = '', $parent_cat_name = '') {
		...
		foreach ($results as $result) {
			...
			//	$output .= '<g:condition>new</g:condition>';
				$output .= ' - ' . $prodData['id'] . 'v20';   //rec_var.prod_var_id+"v20
